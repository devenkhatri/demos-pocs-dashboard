...
export default function ProjectsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setProblem_statement(initialValues.problem_statement);
    setSolution(initialValues.solution);
    setSolution_diagram(initialValues.solution_diagram);
    setDemourl(initialValues.demourl);
    setServices_used(initialValues.services_used);
    setCurrentServices_usedValue("");
    setTags(initialValues.tags);
    setCurrentTagsValue("");
    setIsdisabled(initialValues.isdisabled);
    setErrors({});
  };
